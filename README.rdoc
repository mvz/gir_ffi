...
running the test programs in the project's base directory, and the example
programs in the examples/ folder. Some illustrate what works, some are a
test bed for how things should work. Have a look at rake -T.

== INSTALL:

This doesn't actually work yet, since the gem hasn't been published.
