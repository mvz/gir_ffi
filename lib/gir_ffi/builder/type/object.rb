      ...
      class Object < StructBased
        def setup_method method
          if super
            ...
            if parent
              return superclass._builder.setup_method method
            else
              return false
            end
          end
        ...
        def find_signal signal_name
          ...
          if parent
            return superclass._builder.find_signal signal_name
          end
        end
        ...
        def setup_instance_method_in_ancestor method
          interfaces.each do |iface|
            if iface._builder.setup_instance_method method
              return true
            end
          end
          if parent
            return superclass._builder.setup_instance_method method
          else
            return false
          end
        end
