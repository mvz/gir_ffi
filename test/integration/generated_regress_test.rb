...
describe Regress do
  ...
  describe "Regress::TestObj" do
    ...
    describe "its 'bare' property" do
      it "can be retrieved with #get_property_extended" do
        instance.get_property_extended("bare").must_be_nil
      end
      ...
      it "can be set with #set_property" do
        ...
        instance.get_property_extended("bare").must_equal obj
      end
    ...
    describe "its 'boxed' property" do
      it "can be retrieved with #get_property_extended" do
        instance.get_property_extended("boxed").must_be_nil
      end
      ...
      it "can be set with #set_property" do
        ...
        instance.get_property_extended("boxed").some_int8.must_equal 75
      end
      ...
      it "can be set with #boxed=" do
        ...
        instance.get_property_extended("boxed").some_int8.must_equal tb.some_int8
      end
    end

    describe "its 'double' property" do
      it "can be retrieved with #get_property_extended" do
        instance.get_property_extended("double").must_equal 0.0
      end
      ...
      it "can be set with #set_property" do
        ...
        instance.get_property_extended("double").must_equal 3.14
      end
    ...
    describe "its 'float' property" do
      it "can be retrieved with #get_property_extended" do
        instance.get_property_extended("float").must_equal 0.0
      end
      ...
      it "can be set with #set_property" do
        ...
        instance.get_property_extended("float").must_be_close_to 3.14
      end
    ...
    describe "its 'gtype' property" do
      ...
      it "can be retrieved with #get_property_extended" do
        instance.get_property_extended("gtype").must_equal 0
      end
      ...
      it "can be set with #set_property" do
        ...
        instance.get_property_extended("gtype").must_equal GObject::TYPE_INT64
      end

      it "can be set with #gtype=" do
        instance.gtype = GObject::TYPE_STRING
        instance.gtype.must_equal GObject::TYPE_STRING
        instance.get_property_extended("gtype").must_equal GObject::TYPE_STRING
      end
    end

    describe "its 'hash-table' property" do
      it "can be retrieved with #get_property_extended" do
        instance.get_property_extended("hash-table").must_be_nil
      end
    ...
    describe "its 'hash-table-old' property" do
      it "can be retrieved with #get_property_extended" do
        instance.get_property_extended("hash-table-old").must_be_nil
      end
    ...
    describe "its 'int' property" do
      it "can be retrieved with #get_property_extended" do
        assert_equal 0, instance.get_property_extended("int")
      end
      ...
      it "can be set with #int=" do
        instance.int = 41
        assert_equal 41, instance.get_property_extended("int")
    ...
    describe "its 'string' property" do
      it "can be retrieved with #get_property_extended" do
        assert_nil instance.get_property_extended("string")
      end
      ...
      it "can be set with #set_property" do
        ...
        assert_equal "foobar", instance.get_property_extended("string")
      end
  ...
  describe "Regress::TestWi8021x" do
    ...
    describe "its 'testbool' property" do
      it "can be retrieved with #get_property_extended" do
        instance.get_property_extended("testbool").must_equal true
      end
      ...
      it "can be set with #set_property" do
        ...
        instance.get_testbool.must_equal false
        instance.get_property_extended("testbool").must_equal false
      end
